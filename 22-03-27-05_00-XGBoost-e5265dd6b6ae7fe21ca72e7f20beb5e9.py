...
# MAGIC This is an auto-generated notebook. To reproduce these results, attach this notebook to the **ml** cluster and rerun it.
# MAGIC - Compare trials in the [MLflow experiment](#mlflow/experiments/1519937692149579/s?orderByKey=metrics.%60val_f1_score%60&orderByAsc=false)
# MAGIC - Navigate to the parent notebook [here](#notebook/1519937692149578) (If you launched the AutoML experiment using the Experiments UI, this link isn't very useful.)
...
mlflow.set_experiment("/Users/fm128@duke.edu/databricks_automl/Stress_Level_stress_lysis_csv-2022_03_27-01_00")
...
input_data_path = input_client.download_artifacts("5ff323d69d3041379b0267f98dac5806", "data", input_temp_dir)
...
supported_cols = ["Temperature", "Step_count", "Humidity"]
...
transformers.append(("numerical", numerical_pipeline, ["Temperature", "Step_count", "Humidity"]))
...
X_train, split_X_rem, y_train, split_y_rem = train_test_split(split_X, split_y, train_size=0.6, random_state=739921194, stratify=split_y)

# Split remaining data equally for validation and test
X_val, X_test, y_val, y_test = train_test_split(split_X_rem, split_y_rem, test_size=0.5, random_state=739921194, stratify=split_y_rem)
...
# MAGIC - All the runs are logged under [this MLflow experiment](#mlflow/experiments/1519937692149579/s?orderByKey=metrics.%60val_f1_score%60&orderByAsc=false)
...
xgbc_classifier = XGBClassifier(
  colsample_bytree=0.23841667389519955,
  learning_rate=3.473087131065068,
  max_depth=3,
  min_child_weight=1,
  n_estimators=1972,
  n_jobs=100,
  subsample=0.38439971666750167,
  verbosity=0,
  random_state=739921194,
)
